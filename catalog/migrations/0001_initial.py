# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-18 22:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_aquired', models.DateTimeField(blank=True, null=True, verbose_name=b'date aquired')),
                ('price', models.IntegerField(default=0)),
                ('quantity', models.IntegerField(default=0, null=True)),
                ('thumbnail', models.FileField(blank=True, null=True, upload_to=b'book_images/')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(upload_to=b'book_images/')),
